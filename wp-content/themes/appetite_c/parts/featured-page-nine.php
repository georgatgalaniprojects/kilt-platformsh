<?php
/**
 * This template displays the content for the Featured Page #9
 *
 * @package Appetite
 */

$page_id = get_theme_mod( 'appetite_featured_page_nine_id', '0' );
...
if( $page_id > 0 ):
	...
	<section class="widget front-page-block featured-page-nine">
		<div class="container">

			<?php if( $has_subpages ): ?>

                <?php
                    $section_layout = get_theme_mod( 'appetite_featured_page_nine_layout', '3' );
			...
			<?php else: ?>
				...
				<?php while ( $page_query->have_posts() ) : $page_query->the_post(); ?>
				    <?php get_template_part( 'parts/featured-pages/content', 'nine' ); ?>
				<?php endwhile; ?>

			<?php endif; ?>

		</div><!-- .container -->
	</section><!-- .featured-page-nine -->

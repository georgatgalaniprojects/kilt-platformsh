...
$page_id = get_theme_mod( 'appetite_featured_page_two_id', '0' );
	...
	<section class="widget front-page-block featured-page-two">
		<div class="container">
			...
			<?php if( $has_subpages ): ?>
                ...
                <?php
                    $section_layout = get_theme_mod( 'appetite_featured_page_two_layout', '3' );
			...
			<?php else: ?>
				...
				<?php while ( $page_query->have_posts() ) : $page_query->the_post(); ?>
				    <?php get_template_part( 'parts/featured-pages/content', 'two' ); ?>
				<?php endwhile; ?>

...
<?php
	do_action('emd_archive_before_header', 'youtube-showcase',$post->post_type);
	emd_get_template_part('youtube-showcase', 'archive', str_replace("_","-",$post->post_type) . '-aheader');
	do_action('emd_archive_after_header', 'youtube-showcase',$post->post_type);
?>
	</div>
...
<?php
	do_action('emd_archive_before_footer', 'youtube-showcase',$post->post_type);
	emd_get_template_part('youtube-showcase', 'archive', str_replace("_","-",$post->post_type) . '-afooter');
	do_action('emd_archive_after_footer', 'youtube-showcase',$post->post_type);
?>
</div>

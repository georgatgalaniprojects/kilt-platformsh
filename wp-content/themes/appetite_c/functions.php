...
function appetite_excerpt_more($more)
{
	if (!is_search()) {
		...
		return sprintf(
			'&#x2026; <div class="more-link-container"><a href="%1$s" class="more-link">%2$s</a></div>',
...
function kb_load_open_graph()
{
	...
	$kb_site_logo = 'https://www.kilt.io/wp-content/uploads/2019/08/kilt-logo-google-thumb.png';

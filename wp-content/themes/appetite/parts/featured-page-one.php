<?php
/**
 * This template displays the content for the Featured Page #1
 *
 * @package Appetite
 */

$page_id = get_theme_mod( 'appetite_featured_page_one_id', '0' );
...
if( $page_id > 0 ):
	...
	<section class="widget front-page-block featured-page-one">
		<div class="container">

			<?php if( $has_subpages ): ?>

                <?php
                    $section_layout = get_theme_mod( 'appetite_featured_page_one_layout', '3' );
			...
			<?php else: ?>
				...
				<?php while ( $page_query->have_posts() ) : $page_query->the_post(); ?>
				    <?php get_template_part( 'parts/featured-pages/content', 'one' ); ?>
				<?php endwhile; ?>

			<?php endif; ?>

		</div><!-- .container -->
	</section><!-- .featured-page-one -->

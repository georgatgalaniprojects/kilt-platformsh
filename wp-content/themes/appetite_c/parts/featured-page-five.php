<?php
/**
 * This template displays the content for the Featured Page #5
 *
 * @package Appetite
 */

$page_id = get_theme_mod( 'appetite_featured_page_five_id', '0' );
...
if( $page_id > 0 ):
	...
	<section class="widget front-page-block featured-page-five">
		<div class="container">

			<?php if( $has_subpages ): ?>

                <?php
                    $section_layout = get_theme_mod( 'appetite_featured_page_five_layout', '3' );
			...
			<?php else: ?>
				...
				<?php while ( $page_query->have_posts() ) : $page_query->the_post(); ?>
				    <?php get_template_part( 'parts/featured-pages/content', 'five' ); ?>
				<?php endwhile; ?>

			<?php endif; ?>

		</div><!-- .container -->
	</section><!-- .featured-page-five -->
